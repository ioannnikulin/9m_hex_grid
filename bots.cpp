...
class tokarenko_star_bot:public pc{
public:tokarenko_star_bot(field * p, string n):pc(p, n){}
virtual void ai()
{
int wall(999);
int fog(9999);
...
void fill_bots(vector<pc*> & bots)
{
    ...
    bots.push_back(new tokarenko_star_bot(NULL, "$"));
